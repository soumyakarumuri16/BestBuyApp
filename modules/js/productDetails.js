		...
		if(pResultSet != null && pResultSet["opstatus"] == 0)
		{
			if(pResultSet["reviews"] && pResultSet["reviews"].length)
			{
				...
				for(var i=0;i < pResultSet["reviews"].length;i++)
				{
					...
					"imgStar1":{src:"iconunratedstar.png"},
					"imgStar2":{src:"iconunratedstar.png"},
					"imgStar3":{src:"iconunratedstar.png"},
					"imgStar4":{src:"iconunratedstar.png"},
					"imgStar5":{src:"iconunratedstar.png"},
